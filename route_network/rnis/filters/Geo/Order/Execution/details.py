...
def details(**d):
    ...
    Request.Body.filters(json, 'withDateFrom', d.get('date_from'))
    Request.Body.filters(json, 'withDateTo', d.get('date_to'))
    Request.Body.filters(json, 'withRouteUuid', d.get('uuid'))
